...
class Usuario(models.Model):
    ...
    fechaNacimiento = models.DateTimeField(
        ("fechaNacimiento"), auto_now=False, auto_now_add=False)
...
class Asociado(Usuario):
    documentoAsociado = models.IntegerField(
        primary_key=True, blank=True, null=False, unique=True)
...
class Cliente(Usuario):
    ...
    documentoCliente = models.IntegerField(
        ("DocumentoC"), primary_key=True, blank=True, null=False, unique=True)
